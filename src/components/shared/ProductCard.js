                ...
                
                {
                    ...
                    <div className={styles.productButtons}>
                      ...
                      <div className={styles.quantityButtons}>
                        ...
                        <button onClick={ () => dispatch({type:"UP_QUANTITY", id})}> <img src={plusIcon} alt="icon"/> </button>
                       
                        <span>{quantity ? changeNumberToPersian(quantity) : changeNumberToPersian(0)  }</span>
                        { quantity === 1 
                          ?<button onClick={ () => dispatch({type:"CLEAR_ITEM", id})}> <img src={subtractionIcon}  alt="icon"/> </button> 
                          :<button onClick={ () => dispatch({type:"DOWN_QUANTITY", id})}> <img src={subtractionIcon}  alt="icon"/> </button>
                        }

                     </div>

                       <button  onClick={ () => dispatch({type:"CLEAR_ITEM", id})} className={styles.trashButton}><img src={trashIcon} alt="icon" /></button>
